...
class DistractionsAndEffectsOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Distractions " + (!FlxG.save.data.distractions ? "off" : "on"); // why
	}
}
...
class FPSCapOption extends Option
{
	...
	override function right():Bool
	{
		...
		OptionsMenu.versionShit.text = "Max Framerate: " + FlxG.save.data.fpsCap + " - Description - " + description;
	...
	override function left():Bool
	{
		...
		OptionsMenu.versionShit.text = "Max Framerate: "
